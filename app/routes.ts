...
export type NavigationItem = {
  ...
  path?: string;
  contentPath?: string;
  status?: 'new' | 'updated' | string;
  category?: string;
  preserveOtherCategoryOrder?: boolean;
  categoriesStatus?: Record<string, string>[];
...
const FIRST_APP_TUTORIAL_NAV_DATA: NavigationItem = {
  label: 'First app tutorial',
  path: 'tutorials/first-app',
};

const LEARN_ANGULAR_TUTORIAL_NAV_DATA: NavigationItem = {
  label: 'Learn Angular',
  path: 'tutorials/learn-angular',
};

const DEFERRABLE_VIEWS_TUTORIAL_NAV_DATA: NavigationItem = {
  label: 'Deferrable views',
  path: 'tutorials/deferrable-views',
};

const SIGNALS_TUTORIAL_NAV_DATA: NavigationItem = {
  label: 'Signals tutorial',
  path: 'tutorials/signals',
};

const SIGNAL_FORMS_TUTORIAL_NAV_DATA: NavigationItem = {
  label: 'Signal forms tutorial',
  path: 'tutorials/signal-forms',
};

const getApiNavigationItems = (): NavigationItem[] => [];
const ERRORS_NAV_DATA: NavigationItem[] = [];
const EXT_DIAGNOSTICS_NAV_DATA: NavigationItem[] = [];
